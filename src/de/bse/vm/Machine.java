...
public class Machine {
  ...
  private Byte PINS = new Byte(PIN0, PIN1, PIN2, PIN3, PIN4, PIN5, PIN6, PIN7);
  private Byte DIRS = new Byte(DIR0, DIR1, DIR2, DIR3, DIR4, DIR5, DIR6, DIR7);
  ...
  private Byte B2 = new Byte(), B3 = new Byte(), B4 = new Byte(),
      ...
      B9 = new Byte(), B10 = new Byte(), B11 = new Byte(), B12 = new Byte(),
      B13 = new Byte();

  private Word PORT = new Word(PINS, DIRS), W0 = new Word(B1, B0),
      W1 = new Word(B3, B2), W2 = new Word(B5, B4), W3 = new Word(B7, B6),
      W4 = new Word(B9, B8), W5 = new Word(B11, B10), W6 = new Word(B13, B12);
   ...
   * @param program which the machine shall run
   * @param settings with which the machine shall run
   */
   ...
   * @param name of the IVariable
   * @return IVariable in the machine with this name or constant if name is a number
   */
  public IVariable parseIVariable(String name) { //TODO beautify
    String tmp = name;
    try {
      if (tmp.startsWith("@")) {
        tmp = tmp.substring(1);
  ...
  /**
   * Creates a new IVariable in the machine using a name and a IVariable
   * to be put into the machine.
   * @param name of the new IVariable
   * @param var to be inserted into the machine
   */
